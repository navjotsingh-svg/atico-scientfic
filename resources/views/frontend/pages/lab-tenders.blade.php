...
<div class="breadcrumb-wrapper">
                            <div class="container">
                                <div class="breadcrumb-wrapper-inner">
                                    <span><a class="brd-heading" href="{{ route('home') }}" class="home"><span>Home / Lab Tenders</span></a></span>
...
<div class="container mt-5 p-3">
    <div class="row">
        <div class="col-md-6">
            ...
            <br>
            <p class="about_scientific inter">Technical Support: <a href="tel:+919996186555">+91-999-618-6555</a></p>
